...
namespace backend.Migrations.AdventureWorksLt2019
{
    /// <inheritdoc />
    public partial class AddUserIdToSalesOrderHeader : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkUserLogins = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {

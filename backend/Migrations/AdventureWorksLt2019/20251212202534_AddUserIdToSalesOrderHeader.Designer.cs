...
namespace backend.Migrations.AdventureWorksLt2019
{
    ...
    [Migration("20251212202534_AddUserIdToSalesOrderHeader")]
    partial class AddUserIdToSalesOrderHeader
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("backend.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("backend.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("backend.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Product", b =>
                {
                    ...
                    b.HasOne("backend.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("backend.Models.ProductCategory", b =>
                {
                    b.HasOne("backend.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("backend.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("backend.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("backend.Models.SalesOrderDetail", b =>
                {
                    ...
                    b.HasOne("backend.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("backend.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("backend.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("backend.Models.Address", "ShipToAddress")
